package com.yourteam.nextstop.ui.theme

import androidx.compose.ui.graphics.Color

/**
 * NextStop color palette.
 * Primary seed color: #1565C0 (Deep Blue)
 *
 * All runtime colors should use MaterialTheme.colorScheme roles.
 * This file only defines the static fallback palette for pre-Android 12 devices.
 */

// Seed — used only for generating the fallback palette
...
val md_theme_dark_onPrimary = Color(0xFF003066)
val md_theme_dark_primaryContainer = Color(0xFF004A93)
